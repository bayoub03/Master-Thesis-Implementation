...
Sw3NtQuerySystemInformation PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 010059116h        ; Load function hash into ECX.
...
Sw3NtCreateThreadEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00F2143D5h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 09EB61DBBh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAllocateVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00F911513h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWriteVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 08314A987h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWaitForSingleObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0A8B6A02Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtClose PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 05C8C6529h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
